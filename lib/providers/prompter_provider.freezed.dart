...
class _PrompterState implements PrompterState {
   _PrompterState({this.speed = 1.0, this.mirroredX = false, this.mirroredY = false, this.fontSize = 42.0, this.isPlaying = false, this.sideMargin = 0.0, this.fontFamily = 'Roboto', this.alignment = TextAlign.left, this.displayReadingIndicatorBoxes = false, this.readingIndicatorBoxesHeight = 60.0, this.displayVerticalMarginBoxes = false, this.verticalMarginBoxesHeight = 35.0, this.countdownDuration = 0.0, this.displayCountdown = false, this.verticalMarginBoxesFadeEnabled = false, this.verticalMarginBoxesFadeLength = 50.0, this.markdownEnabled = false, this.showControlButtons = false, this.controlButtonsPosition = ControlButtonsPosition.left});
